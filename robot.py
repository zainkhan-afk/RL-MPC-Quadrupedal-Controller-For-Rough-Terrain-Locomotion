...
class Robot(object):
    ...
    def init_simulator(self):
        if self.visualization:
            p.connect(p.GUI, options = "--mp4=/home/zainullah/thesis/gitCode/hybrid_gait/movie.mp4 --mp4fps=60")  # or p.DIRECT for non-graphical version
        ...
        if self.terrain == "plane":
            ...
            cv2.imwrite("/home/zainullah/thesis/gitCode/hybrid_gait/land_tex.png", tex_data_color)

            textureId = p.loadTexture("/home/zainullah/thesis/gitCode/hybrid_gait/land_tex.png")
